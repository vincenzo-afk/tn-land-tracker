...
export default function LandDetailPage({ params }: { params: { id: string } | Promise<{ id: string }> }) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="space-y-8">
        ...
        >
          {loadingLand ? <SkeletonBlock h="h-80" /> : <MapView lat={land?.lat} lon={land?.lon} village={land?.village} label={`Survey No. ${land?.survey_number}`} />}
        </LandDetailSection>
      </div>
